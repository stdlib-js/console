...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/console@v0.3.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { log, logEach } from 'https://cdn.jsdelivr.net/gh/stdlib-js/console@v0.3.1-esm/index.mjs';
```
